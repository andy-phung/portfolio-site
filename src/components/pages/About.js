...
const About = () => {
  return (
    <div className="font-regular leading-bio h-auto w-[76.7vw] mt-[6.5vh] flex flex-col flex-shrink-0 flex-grow-0">
        ...
        <div className="w-full flex flex-shrink-0 flex-grow-0 mt-[15px]">
          ...
          <div className="w-[40.4%] mt-[-5px] ml-[20px] flex flex-col flex-shrink-0 flex-grow-0">
            <div className="text-normal mt-[2px]">
              <div className=""><span className="">hi, thanks for stopping by!</span><br/><br/>i'm andy, a sophomore at mit passionate about using design to bring stories to life.</div> 
